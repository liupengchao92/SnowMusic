...
public class SystemUtils {
    ...
    public static boolean isOpenFloatWindow() {
        return FloatUtil.INSTANCE.checkPermission(MusicApplication.Companion.getContext());
    }
    ...
    public static void applySystemWindow() {
        FloatUtil.INSTANCE.applyOrShowFloatWindow(MusicApplication.Companion.getContext());
    }
    ...
    private static boolean isNoOptions() {
        PackageManager packageManager = MusicApplication.Companion.getContext().getPackageManager();
    ...
    private static boolean isNoSwitch() {
        ...
        UsageStatsManager usageStatsManager = (UsageStatsManager) MusicApplication.Companion.getContext().getSystemService(Context.USAGE_STATS_SERVICE);
